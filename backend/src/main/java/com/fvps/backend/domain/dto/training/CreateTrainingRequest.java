...
public class CreateTrainingRequest {
    ...
    @Schema(
            ...
            example = "Basic safety rules for factory visitors.",
            requiredMode = Schema.RequiredMode.REQUIRED
    )
    ...
    @Schema(
            description = "Type/Category of the training",
            example = "OHS",
            requiredMode = Schema.RequiredMode.REQUIRED
    )
    ...
    @Schema(
            description = "Security clearance level granted upon completion (1-4)",
            example = "2",
            minimum = "1",
            maximum = "4"
    )
